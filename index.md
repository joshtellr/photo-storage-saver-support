...
Everything the app removes goes to Photos' **Recently Deleted** album, where it
stays recoverable for around 30 days. The app never bypasses this.

**Why didn't a video get smaller after compressing?**
The app refuses to replace a video unless the re-encoded file is genuinely
smaller. Some clips are already efficiently encoded — those are reported as
